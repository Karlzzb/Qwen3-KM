...
model = AutoModelForCausalLM.from_pretrained(model_dir, dtype=load_dtype)
model.enable_input_require_grads()  # 开启梯度检查点时，要执行该方法
model.to(device)

# 加载、处理数据集和测试集
train_dataset_path = os.path.join(script_path, "data/train.jsonl")
val_dataset_path = os.path.join(script_path, "data/val.jsonl")

train_jsonl_new_path = os.path.join(script_path, "data/train_format.jsonl")
val_jsonl_new_path = os.path.join(script_path, "data/val_format.jsonl")
